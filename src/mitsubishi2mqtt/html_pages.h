...
const char html_page_syslog[] PROGMEM =
"<div id='l1' name='l1'>"
    "<fieldset>"
        "<legend><b>&nbsp; _TXT_SYSLOG_TITLE_ &nbsp;</b></legend>"
        "<form method='post'>"
            "<p><b>_TXT_SYSLOG_ACTIVE_</b>"
                "<select name='active'>"
                    "<option value='ON' _SYSLOG_ON_>_TXT_F_ON_</option>"
                    "<option value='OFF' _SYSLOG_OFF_>_TXT_F_OFF_</option>"
                "</select>"
            "</p>"
            "<p><b>_TXT_SYSLOG_HOST_</b>"
                "<br/>"
                "<input id='host' name='host' "
                "autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' "
                "placeholder='' value='_SYSLOG_HOST_'>"
            "</p>"
            "<p><b>_TXT_SYSLOG_PORT_</b>"
                "<br/>"
                "<input id='ml' name='ml' type='numeric' placeholder='514' value='_SYSLOG_PORT_'>"
            "</p>"
            "<p><b>_TXT_SYSLOG_FACILITY_</b>"
                "<select name='facility'>"
                    "<option value='local0' _SYSLOG_LOCAL0_FACILITY_>local0</option>"
                    "<option value='local1' _SYSLOG_LOCAL1_FACILITY_>local1</option>"
                    "<option value='local2' _SYSLOG_LOCAL2_FACILITY_>local2</option>"
                    "<option value='local3' _SYSLOG_LOCAL3_FACILITY_>local3</option>"
                    "<option value='local4' _SYSLOG_LOCAL4_FACILITY_>local4</option>"
                    "<option value='local5' _SYSLOG_LOCAL5_FACILITY_>local5</option>"
                    "<option value='local6' _SYSLOG_LOCAL6_FACILITY_>local6</option>"
                    "<option value='local7' _SYSLOG_LOCAL7_FACILITY_>local7</option>"
                "</select>"
            "</p>"
            "<br/>"
            "<button name='save' type='submit' class='button bgrn'>_TXT_SAVE_</button>"
